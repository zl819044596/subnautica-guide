...
export const metadata: Metadata = {
  title: "Stasis Rifle 制作攻略：材料清单与升级路线 | Subnautica 2 指南",
  description: "Subnautica 2 Stasis Rifle 制作攻略：完整材料清单和升级路线。",
  keywords: ["subnautica 2", "stasis rifle", "crafting", "guide"],
};
  ...
  return (
    <main className="min-h-screen bg-[#0a1628] px-4 pt-24 pb-16">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-6">Stasis Rifle 制作攻略</h1>

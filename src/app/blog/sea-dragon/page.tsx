...
export const metadata: Metadata = {
  title: "Sea Dragon 完全指南：栖息地、行为与生存技巧 | Subnautica 2 指南",
  description: "了解 Subnautica 2 中的 Sea Dragon：栖息地、行为模式、掉落物和生存技巧。",
  keywords: ["subnautica 2", "sea dragon", "guide", "creature"],
};
  ...
  return (
    <main className="min-h-screen bg-[#0a1628] px-4 pt-24 pb-16">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-6">Sea Dragon 完全指南</h1>

...
export const metadata: Metadata = {
  title: "Nickel Ore 获取位置大全：最快收集路线 | Subnautica 2 指南",
  description: "Subnautica 2 Nickel Ore 最佳获取位置：快速收集路线和技巧。",
  keywords: ["subnautica 2", "nickel ore", "location", "guide"],
};
  ...
  return (
    <main className="min-h-screen bg-[#0a1628] px-4 pt-24 pb-16">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-6">Nickel Ore 获取位置大全</h1>

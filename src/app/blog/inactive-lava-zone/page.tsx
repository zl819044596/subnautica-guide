...
export const metadata: Metadata = {
  title: "Inactive Lava Zone 探索指南：资源、危险与生存策略 | Subnautica 2 指南",
  description: "探索 Subnautica 2 的 Inactive Lava Zone：资源分布、危险生物和生存策略。",
  keywords: ["subnautica 2", "inactive lava zone", "biome", "guide"],
};
  ...
  return (
    <main className="min-h-screen bg-[#0a1628] px-4 pt-24 pb-16">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-6">Inactive Lava Zone 探索指南</h1>

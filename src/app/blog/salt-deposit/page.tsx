...
export const metadata: Metadata = {
  title: "Salt Deposit 获取位置大全：最快收集路线 | Subnautica 2 指南",
  description: "Subnautica 2 Salt Deposit 最佳获取位置：快速收集路线和技巧。",
  keywords: ["subnautica 2", "salt deposit", "location", "guide"],
};
  ...
  return (
    <main className="min-h-screen bg-[#0a1628] px-4 pt-24 pb-16">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-6">Salt Deposit 获取位置大全</h1>
